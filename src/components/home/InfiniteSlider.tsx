        ...
        <div className="animate-slider-left flex whitespace-nowrap gap-6 py-2">
          {items.map((item, idx) => (
            <div 
              key={`slider-1-${idx}`} 
              className={cn(
                "inline-flex items-center px-6 py-3 border border-slate-200/50 dark:border-slate-800/50 rounded-full shadow-sm transition-all duration-300 hover:shadow-md",
                item.bgColor
              )}
            >
